...
const HowGitScopeWorksClient = () => {
  return (
    <main className='how-gitscope-works-client'>
      <DocsArticle
      ...
      >
        <section id='core-pipeline'>
          ...
          <p>
            GitScope follows a simple data flow. GitHub provides the source
            data, GitScope processes the relevant information, and the interface
        ...
        <section id='analytics-layer'>
          ...
          <p>
            ...
            visualizations such as repository rankings, language distributions
