...
import '../../../styles/components/terms/aboutTeam/AboutTeamShowcase.scss';

const AboutTeamShowcase = ({ teamVisual }: AboutTeamShowcaseProps) => {
  return (
    <div className='about-team-showcase'>
      <TeamVisual {...teamVisual} />

      <div className='about-team-showcase__content'>
        <span className='about-team-showcase__content--label'>
          A focused team with a developer-first approach
        </span>

        <h3 className='about-team-showcase__content--title'>
          We build GitScope to make GitHub activity easier to understand.
        </h3>

        <p className='about-team-showcase__content--paragraph'>
